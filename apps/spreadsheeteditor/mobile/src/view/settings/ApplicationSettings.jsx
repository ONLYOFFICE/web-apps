...
const PageApplicationSettings = props => {
    ...
    const formuleLangsColection = storeApplicationSettings.formuleLangsColection;
    const defineFormulaLang = () => formuleLangsColection.find(obj => obj.value === formulaLang);
...
const PageFormulaLanguage = props => {
    ...
    return (
        <Page>
            ...
            <List mediaList>
                {formuleLangsColection.map((elem, index) => {
                    return (

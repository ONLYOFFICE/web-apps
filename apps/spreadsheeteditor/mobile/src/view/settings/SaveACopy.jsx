...
const SaveACopy = props => {
    ...
    return (
        <Page>
            ...
            <List>
                <ListItem title="XLSX" onClick={() => props.onSaveFormat(Asc.c_oAscFileType.XLSX, '.xlsx')}>
                ...
                <ListItem title="ODS" onClick={() => props.onSaveFormat(Asc.c_oAscFileType.ODS, '.ods')}>
                    <SvgIcon slot="media" symbolId={IconFormatOds.id} className={'icon icon-svg'} />
                </ListItem>
                <ListItem title="CSV" onClick={() => props.onSaveFormat(Asc.c_oAscFileType.CSV, '.csv')}>
                    <SvgIcon slot="media" symbolId={IconFormatCsv.id} className={'icon icon-svg'} />
                </ListItem>
                <ListItem title="XLTX" onClick={() => props.onSaveFormat(Asc.c_oAscFileType.XLTX, '.xltx')}>
                    <SvgIcon slot="media" symbolId={IconFormatXltx.id} className={'icon icon-svg'} />
                </ListItem>
                <ListItem title="OTS" onClick={() => props.onSaveFormat(Asc.c_oAscFileType.OTS, '.ots')}>
...
export default inject('storeSpreadsheetInfo', 'storeAppOptions')(observer(SaveACopy));
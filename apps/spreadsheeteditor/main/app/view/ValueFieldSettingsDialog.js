                    ...
                    '<div class="box" style="height:' + (me.options.height - 85) + 'px;">',
                        ...
                        '<tr>',
                            '<td class="padding-large">',
                                ...
                                '<div id="value-field-settings-showas" class="input-group-nr" style="width:128px;"></div>',
                            '</td>',
                            '<td class="padding-large float-right">',
                                '<label></label>',
                                '<div id="value-field-settings-numformat" style="width:128px;"></div>',
                            '</td>',
                        '</tr>',

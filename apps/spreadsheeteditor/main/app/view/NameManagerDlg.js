    ...
    SSE.Views.NameManagerDlg =  Common.Views.AdvancedSettingsWindow.extend(_.extend({
        ...
        render: function () {
            ...
            this.rangeList = new Common.UI.ListView({
                ...
                headers: [
                    {name: me.textRanges,       width: 171, sortType:'name',        style: 'padding-right: 12px;'},
                    {name: me.textScope,        width: 122, sortType:'scopeName',   style: 'padding-right: 12px;'},
                ...
                itemTemplate: _.template([
                        '<div id="<%= id %>" class="list-item" style="width: 100%;display:inline-block;<% if (!lock) { %>pointer-events:none;<% } %>">',
                            ...
                            '<div style="width:146px;padding-right: 5px;"><%= Common.Utils.String.htmlEncode(name) %></div>',
                            '<div style="width:122px;padding-right: 5px;"><%= scopeName %></div>',

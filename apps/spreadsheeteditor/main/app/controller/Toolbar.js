    ...
    SSE.Controllers.Toolbar = Backbone.Controller.extend(_.extend({
        ...
        setMode: function(mode) {
            ...
            Common.UI.TooltipManager.addTips({
                ...
                'backgroundOpen' : {text: _main.textContinuesOpeningDescription, header: _main.textContinuesOpening, target: '#toolbar', maxwidth: 'none', showButton: false, automove: true, noHighlight: true, noArrow: true, multiple: true},

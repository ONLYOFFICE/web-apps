...
define([
    ...
    PE.Controllers.Toolbar = Backbone.Controller.extend(_.extend({
        ...
        attachUIEvents: function(toolbar) {
            ...
            toolbar.btnShapeDistribute.menu.on('item:click',            _.bind(this.onShapeAlign, this));
            toolbar.btnShapeDistribute.menu.on('show:before',           _.bind(this.onBeforeShapeAlign, this));
        ...
        onApiFocusObject: function(selectedObjects) {
            ...
            var me = this,
                ...
                no_text = true,
                no_object = true,
                drawing_objects = this.api.asc_getSelectedDrawingObjectsCount(),
                no_drawing_objects = drawing_objects<1,
                in_equation = false,
                in_chart = false,
                in_para = false,
                layout_index = -1,

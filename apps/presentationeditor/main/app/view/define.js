        ...
        return {
            ...
            getEffectFullData: function () {
                return [
                    ...
                    {group: 'menu-effect-group-path',       level: 'menu-effect-level-lines_curves',    value: AscFormat.MOTION_LEFT,                       iconCls: 'animation-motion-paths-lines',    displayValue: this.textLeft,                familyEffect: 'pathlines'},
                    {group: 'menu-effect-group-path',       level: 'menu-effect-level-lines_curves',    value: AscFormat.MOTION_RIGHT,                      iconCls: 'animation-motion-paths-lines',    displayValue: this.textRight,               familyEffect: 'pathlines'},
                    ...
                    {group: 'menu-effect-group-path',       level: 'menu-effect-level-lines_curves',    value: AscFormat.MOTION_TURN_DOWN,                  iconCls: 'animation-motion-paths-turn-downneutral',    displayValue: this.textTurnDown,            familyEffect: 'pathturns'},
                    {group: 'menu-effect-group-path',       level: 'menu-effect-level-lines_curves',    value: AscFormat.MOTION_TURN_DOWN_RIGHT,            iconCls: 'animation-motion-paths-turn-down-rightneutral',    displayValue: this.textTurnDownRight,       familyEffect: 'pathturns'},
                    {group: 'menu-effect-group-path',       level: 'menu-effect-level-lines_curves',    value: AscFormat.MOTION_TURN_UP,                    iconCls: 'animation-motion-paths-turn-upneutral',    displayValue: this.textTurnUp,              familyEffect: 'pathturns'},
                    {group: 'menu-effect-group-path',       level: 'menu-effect-level-lines_curves',    value: AscFormat.MOTION_TURN_UP_RIGHT,              iconCls: 'animation-motion-paths-turn-up-rightneutral',    displayValue: this.textTurnUpRight,         familyEffect: 'pathturns'},
                    {group: 'menu-effect-group-path',       level: 'menu-effect-level-lines_curves',    value: AscFormat.MOTION_UP,                         iconCls: 'animation-motion-paths-lines',    displayValue: this.textUp,                  familyEffect: 'pathlines'},
                    ...
                    {group: 'menu-effect-group-path',       level: 'menu-effect-level-special',         value: AscFormat.MOTION_VERTICAL_FIGURE_8,          iconCls: 'animation-motion-paths-vertical-figure-8neutral',    displayValue: this.textVerticalFigure,      familyEffect: 'pathloops'},

...
define([
    ...
    DE.Views.HyphenationDialog = Common.UI.Window.extend(_.extend({
        ...
        initialize : function(options) {
            ...
            this.template = [
                '<div class="box" style="">',
                    '<div id="hyphenation-chk-auto" style="margin-bottom: 15px;"></div>',
                    '<div id="hyphenation-chk-caps" style="margin-bottom: 15px;"></div>',
                    '<label class="margin-right-5">' + this.textLimit + '</label>',
                    '<div id="hyphenation-num-limit" style="margin-bottom: 10px;display: inline-block;"></div>',
                '</div>'
            ].join('');

...
//                hint        : this.tipParagraphStyle,
            ...
            createDelayedElements: function () {
                ...
                loadPreset('resources/numbering/multilevel-lists.json', this.mode.lang, function (presets) {
                    var arr = [{id: 'id-multilevels-' + Common.UI.getId(), numberingInfo: '{"Type":"remove"}', skipRenderOnChange: true, tip: me.textNone, group : libGroup, type: 1}];

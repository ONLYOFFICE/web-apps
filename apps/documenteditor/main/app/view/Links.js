    ...
    _.extend(
      (function () {
        function setEvents() {
          ...
          this.btnContentsUpdate.menu.on(
            "item:click",
        ...
        return {
          ...
          initialize: function (options) {
            ...
            this.btnsHyperlink = Common.Utils.injectButtons(
              ...
              "",
              "toolbar__icon btn-inserthyperlink",
              me.capBtnInsLink,
              [
                _set.paragraphLock,
                _set.headerLock,
          ...
          onAppReady: function (config) {
            ...
            new Promise(function (accept, reject) {
              ...
              me.btnContentsUpdate.updateHint([
                me.textUpdateAll,
                me.tipContentsUpdate,
              ]);
              me.btnContentsUpdate.setMenu(
                new Common.UI.Menu({
                  items: [
              ...
              me.btnsNotes.forEach(function (btn, index) {
                ...
                var _menu = new Common.UI.Menu({
                  items: [
                        ...
                        ? _.template(
                            [
                              ...
                              '<label class="title float-left">' +
                                me.textGotoFootnote +
                                "</label>",
                              '<button id="id-menu-goto-footnote-next-' +
                                index +
                                '" type="button" class="btn small btn-toolbar next float-right"><i class="icon menu__icon btn-nextitem">&nbsp;</i></button>',
                              '<button id="id-menu-goto-footnote-prev-' +
                                index +
                                '" type="button" class="btn small btn-toolbar prev float-right"><i class="icon menu__icon btn-previtem">&nbsp;</i></button>',
                              "</div>",
                            ].join("")
                          )
                        : _.template(
                        ...
                        ? _.template(
                            [
                              ...
                              '<label class="title float-left">' +
                                me.textGotoEndnote +
                                "</label>",
                              '<button id="id-menu-goto-endnote-next-' +
                                index +
                                '" type="button" class="btn small btn-toolbar next float-right"><i class="icon menu__icon btn-nextitem">&nbsp;</i></button>',
                              '<button id="id-menu-goto-endnote-prev-' +
                                index +
                                '" type="button" class="btn small btn-toolbar prev float-right"><i class="icon menu__icon btn-previtem">&nbsp;</i></button>',
                              "</div>",
                            ].join("")
                    ...
                    {
                      caption: me.mniConvertNote,
                      value: "convert",
                      menu: new Common.UI.Menu({
                        menuAlign: "tl-tr",
                        items: [
                          {
                            caption: me.textConvertToEndnotes,
                            value: "to-endnotes",
                          },
                          {
                            caption: me.textConvertToFootnotes,
                            value: "to-footnotes",
                          },
              ...
              me.btnsHyperlink.forEach(function (btn) {
                btn.updateHint(
                  me.tipInsertHyperlink +
                    Common.Utils.String.platformKey("Ctrl+K")
                );
              });

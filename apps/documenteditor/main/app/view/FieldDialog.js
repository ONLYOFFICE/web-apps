...
define([], function () { 'use strict';
    ...
    DE.Views.FieldDialog = Common.UI.Window.extend(_.extend({
        ...
        initialize : function(options) {
            ...
            this.template = [
                '<div class="box">',
                    ...
                    '</div>',
                    '<div id="id-dlg-label-fieldname" class="input-row"></div>',
                    '<div class="input-row">',
                        '<label class="light">' + this.textExample + '</label>',
                    '</div>',
                '</div>'
            ].join('');
        ...
        textTitle: 'Field',
        textLabel: 'Field codes',
        textExample: 'Example of writing code: TIME \\@ "dddd, MMMM d, yyyy"'
    }, DE.Views.FieldDialog || {}));
});
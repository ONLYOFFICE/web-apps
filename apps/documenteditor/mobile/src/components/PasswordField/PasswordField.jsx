...
const PasswordField = ({ label, placeholder, value, handlerChange }) => {
            ...
            <div className='item-content item-input password-field'>
                <div className='item-inner'>
                    ...
                    <div className='item-input-wrap password-field__wrap'>
                        <input type={isShowPassword ? 'type' : 'password'} placeholder={placeholder} value={password} onChange={handlePasswordChange} className='password-field__input' />
                        {!isIos && 

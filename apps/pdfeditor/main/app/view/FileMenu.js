...
define([
    ...
    PDFE.Views.FileMenu = Common.UI.BaseView.extend(_.extend({
        ...
        applyMode: function() {
            ...
            this.miSave[(this.mode.isEdit || this.mode.isRestrictedEdit && this.mode.isDesktopApp && this.mode.isOffline) && Common.UI.LayoutManager.isElementVisible('toolbar-file-save') ?'show':'hide']();

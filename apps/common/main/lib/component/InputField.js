...
define([
    ...
    (function () {
      return {
        ...
        _doChange: function (e, extra) {
          ...
          this.value = newValue;
          if (this.validateOnBlur) this.checkValidate();
        ...
        onKeyPress: function (e) {
          ...
          if (this.options.maskExp && !_.isEmpty(this.options.maskExp.source)) {
            ...
            if (
              !this.options.maskExp.test(charCode) &&
              !e.ctrlKey &&
        ...
        onKeyDown: function (e) {
          ...
          if (e.keyCode === Common.UI.Keys.RETURN) this._doChange(e);
          if (e.keyCode == Common.UI.Keys.ESC) this.setValue(this.value);
          if (
            e.keyCode == Common.UI.Keys.RETURN ||
  ...
  Common.UI.InputFieldBtnPassword = Common.UI.InputFieldBtn.extend(
    _.extend(
      (function () {
        return {
          options: {
          ...
          render: function (parentEl) {
            ...
            else this._btnElm.on("mousedown", _.bind(this.passwordShow, this));
  ...
  Common.UI.InputFieldBtnCalendar = Common.UI.InputFieldBtn.extend(
    (function () {
      return {
        options: {
          id: null,
        ...
        render: function (parentEl) {
          ...
          var id = "id-" + Common.UI.getId() + "input-field-datetime",
            menu = new Common.UI.Menu({
              ...
              items: [
                {
                  template: _.template('<div id="' + id + '" style=""></div>'),
    ...
    (function () {
      return {
        ...
        render: function (parentEl) {
          ...
          if (this.fixedValue) this.setFixedValue(this.fixedValue);
        ...
        setFixedValue: function (value) {
          ...
          if (this.rendered) {
            this.cmpEl
              .find("input.fixed-text")
              .addBack()
              .filter("input.fixed-text")
              .val(value);
          }
        },

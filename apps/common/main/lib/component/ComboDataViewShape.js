    ...
    Common.UI.ComboDataViewShape = Common.UI.BaseView.extend({
        ...
        initialize : function(options) {
            ...
            this.fieldPicker = new Common.UI.DataView({
                ...
                itemTemplate: _.template('<div class="item-shape" id="<%= id %>" data-shape="<%= data.shapeType %>"><svg width="20" height="20" class=\"icon permanent-icon\"><use xlink:href=\"#svg-icon-<%= data.shapeType %>\"></use></svg></div>'),

            ...
            getChartData: function () {
                return [
                    ...
                    },
                    {
                        ...
                        tip: this.textBarNormal3dPerspective,
                        is3d: true
                    },
                    {
                    ...
                    },
                    {
                        ...
                        iconCls: 'line-stack',
                        tip: this.textLineStacked
                    },
                    {
                        group: 'menu-chart-group-line',
                        type: Asc.c_oAscChartTypeSettings.lineStackedPer,
                        iconCls: 'line-pstack',
                        tip: this.textLineStackedPer
                    },
                    {
                        group: 'menu-chart-group-line',
                        type: Asc.c_oAscChartTypeSettings.lineNormalMarker,
                        iconCls: 'line-normal-marker',
                        tip: this.textLineMarker
                    },
                    {
                        group: 'menu-chart-group-line',
                        type: Asc.c_oAscChartTypeSettings.lineStackedMarker,
                        iconCls: 'line-stack-marker',
                        tip: this.textLineStackedMarker
                    },
                    {
                        group: 'menu-chart-group-line',
                        type: Asc.c_oAscChartTypeSettings.lineStackedPerMarker,
                        iconCls: 'line-pstack-marker',
                        tip: this.textLineStackedPerMarker
                    },
                    {
                        group: 'menu-chart-group-line',
                    ...
                    },
                    {
                        ...
                        iconCls: 'area-stack',
                        tip: this.textAreaStacked
                    },
                    {
                        group: 'menu-chart-group-area',
                        type: Asc.c_oAscChartTypeSettings.areaStackedPer,
                        iconCls: 'area-pstack',
                        tip: this.textAreaStackedPer
                    },
                    {
                        group: 'menu-chart-group-scatter',
                        type: Asc.c_oAscChartTypeSettings.scatter,
                        iconCls: 'point-normal',
                        tip: this.textScatter
                    },
                    {
                        group: 'menu-chart-group-scatter',
                        type: Asc.c_oAscChartTypeSettings.scatterSmoothMarker,
                        iconCls: 'point-smooth-marker',
                        tip: this.textScatterSmoothMarker
                    },
                    {
                        group: 'menu-chart-group-scatter',
                        type: Asc.c_oAscChartTypeSettings.scatterSmooth,
                        iconCls: 'point-smooth',
                        tip: this.textScatterSmooth
                    },
                    {
                        group: 'menu-chart-group-scatter',
                        type: Asc.c_oAscChartTypeSettings.scatterLineMarker,
                        iconCls: 'point-line-marker',
                        tip: this.textScatterLineMarker
                    },
                    {
                        group: 'menu-chart-group-scatter',
                        type: Asc.c_oAscChartTypeSettings.scatterLine,
                        iconCls: 'point-line',
                        tip: this.textScatterLine
                    },
                    {
                    ...
                    {
                        group: 'menu-chart-group-combo',
                        type: Asc.c_oAscChartTypeSettings.comboBarLine,
                        iconCls: 'combo-bar-line',
                        tip: this.textComboBarLine
                    },
                    {
                        group: 'menu-chart-group-combo',
                        type: Asc.c_oAscChartTypeSettings.comboBarLineSecondary,
                        iconCls: 'combo-bar-line-sec',
                        tip: this.textComboBarLineSecondary
                    },
                    {
                        group: 'menu-chart-group-combo',
                        type: Asc.c_oAscChartTypeSettings.comboAreaBar,
                        iconCls: 'combo-area-bar',
                        tip: this.textComboAreaBar
                    },
                    {
                        group: 'menu-chart-group-combo',
                        type: Asc.c_oAscChartTypeSettings.comboCustom,
                        iconCls: 'combo-custom',
                        tip: this.textComboCustom
                    }
            ...
            getEffectOptionsData: function (group) {
                ...
                switch (group) {
                    case 'menu-effect-group-entrance':
                        ...
                        arr[AscFormat.ENTRANCE_CHECKERBOARD] = [
                        ...
                        arr[AscFormat.ENTRANCE_PEEK_IN_FROM] = [
                        ...
                        arr[AscFormat.ENTRANCE_WEDGE] = [];
                        arr[AscFormat.ENTRANCE_WHEEL] = [
                        ...
                        arr[AscFormat.ENTRANCE_WIPE_FROM] = [
                        ...
                        arr[AscFormat.ENTRANCE_EXPAND] = [];
                        arr[AscFormat.ENTRANCE_FADE] = [];
                        arr[AscFormat.ENTRANCE_SWIVEL] = [];
                        arr[AscFormat.ENTRANCE_ZOOM] = [
                        ...
                        arr[AscFormat.ENTRANCE_BASIC_ZOOM] = [
                            {value: AscFormat.ENTRANCE_BASIC_ZOOM_IN, caption: this.textIn},
                            {
                                value: AscFormat.ENTRANCE_BASIC_ZOOM_IN_FROM_SCREEN_CENTER,
                            ...
                            {
                                value: AscFormat.ENTRANCE_BASIC_ZOOM_OUT_FROM_SCREEN_BOTTOM,
                                caption: this.textOutFromScreenBottom
                            },
                            {value: AscFormat.ENTRANCE_BASIC_ZOOM_OUT_SLIGHTLY, caption: this.textOutSlightly}
                        ];
                        arr[AscFormat.ENTRANCE_CENTER_REVOLVE] = [];
                        arr[AscFormat.ENTRANCE_CENTER_COMPRESS] = [];
                        arr[AscFormat.ENTRANCE_FLOAT_DOWN] = [];
                        arr[AscFormat.ENTRANCE_FLOAT_UP] = [];
                        arr[AscFormat.ENTRANCE_GROW_AND_TURN] = [];
                        arr[AscFormat.ENTRANCE_RISE_UP] = [];
                        arr[AscFormat.ENTRANCE_SPINNER] = [];
                        arr[AscFormat.ENTRANCE_STRETCH] = [
                        ...
                        arr[AscFormat.ENTRANCE_BASIC_SWIVEL] = [
                        ...
                        arr[AscFormat.ENTRANCE_BOOMERANG] = [];
                        arr[AscFormat.ENTRANCE_BOUNCE] = [];
                        arr[AscFormat.ENTRANCE_CREDITS] = [];
                        arr[AscFormat.ENTRANCE_CURVE_UP] = [];
                        arr[AscFormat.ENTRANCE_DROP] = [];
                        arr[AscFormat.ENTRANCE_FLIP] = [];
                        arr[AscFormat.ENTRANCE_FLOAT] = [];
                        arr[AscFormat.ENTRANCE_PINWHEEL] = [];
                        arr[AscFormat.ENTRANCE_SPIRAL_IN] = [];
                        arr[AscFormat.ENTRANCE_WHIP] = [];

                        return arr;

                    case 'menu-effect-group-exit':
                        arr[AscFormat.EXIT_BLINDS] = [
                        ...
                        arr[AscFormat.EXIT_PEEK_OUT_TO] = [
                        ...
                        arr[AscFormat.EXIT_WEDGE] = [];
                        arr[AscFormat.EXIT_WHEEL] = [
                        ...
                        arr[AscFormat.EXIT_CONTRACT] = [];
                        arr[AscFormat.EXIT_FADE] = [];
                        arr[AscFormat.EXIT_SWIVEL] = [];
                        arr[AscFormat.EXIT_ZOOM] = [
                            {value: AscFormat.ENTRANCE_ZOOM_OBJECT_CENTER, caption: this.textObjectCenter},
                            {value: AscFormat.ENTRANCE_ZOOM_SLIDE_CENTER, caption: this.textSlideCenter}
                        ];
                        arr[AscFormat.EXIT_BASIC_ZOOM] = [
                            {value: AscFormat.EXIT_BASIC_ZOOM_IN, caption: this.textIn},
                            {
                                value: AscFormat.EXIT_BASIC_ZOOM_IN_TO_SCREEN_BOTTOM,
                            ...
                            {
                                value: AscFormat.EXIT_BASIC_ZOOM_OUT_TO_SCREEN_CENTER,
                                caption: this.textOutToScreenBottom
                            },
                            {value: AscFormat.EXIT_BASIC_ZOOM_OUT_SLIGHTLY, caption: this.textOutSlightly}
                        ];
                        arr[AscFormat.EXIT_CENTER_REVOLVE] = [];
                        arr[AscFormat.EXIT_COLLAPSE] = [
                        ...
                        arr[AscFormat.EXIT_FLOAT_DOWN] = [];
                        arr[AscFormat.EXIT_FLOAT_UP] = [];
                        arr[AscFormat.EXIT_SHRINK_AND_TURN] = [];
                        //sink down- EXIT_SHRINK_DOWN?
                        arr[AscFormat.EXIT_SPINNER] = [];
                        arr[AscFormat.EXIT_STRETCHY] = [];
                        arr[AscFormat.EXIT_BASIC_SWIVEL] = [
                        ...
                        arr[AscFormat.EXIT_BOOMERANG] = [];
                        arr[AscFormat.EXIT_BOUNCE] = [];
                        arr[AscFormat.EXIT_CREDITS] = [];
                        arr[AscFormat.EXIT_CURVE_DOWN] = [];
                        arr[AscFormat.EXIT_DROP] = [];
                        arr[AscFormat.EXIT_FLIP] = [];
                        arr[AscFormat.EXIT_FLOAT] = [];
                        arr[AscFormat.EXIT_PINWHEEL] = [];
                        arr[AscFormat.EXIT_SPIRAL_OUT] = [];
                        arr[AscFormat.EXIT_WHIP] = [];
